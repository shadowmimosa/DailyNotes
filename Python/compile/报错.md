...
- 参考
  [“pyconfig.h: fatal error C1083: 无法打开包括文件: “io.h”: No such file”解决办法](https://blog.csdn.net/q454706532/article/details/79636284)
  [pyconfig.h(59) fatal error C1083: Cannot open include file: 'io.h': No such file or directory](https://stackoverflow.com/questions/54151872/pyconfig-h59-fatal-error-c1083-cannot-open-include-file-io-h-no-such-file)
  [CL environment variables](https://docs.microsoft.com/en-us/cpp/build/reference/cl-environment-variables?view=msvc-160&viewFallbackFrom=vs-2019)
  [在 Windows 命令行中使用 cl.exe——如何设置环境变量](https://blog.csdn.net/weixin_43997331/article/details/104764873)
  [使用 Pip 安装 Python 软件包时如何使用 MinGW 的 gcc 编译器？](https://www.imooc.com/wenda/detail/596960)
  ['io.h': No such file or directory during “pip install netifaces”](https://stackoverflow.com/questions/45904828/io-h-no-such-file-or-directory-during-pip-install-netifaces)
  [Microsoft Visual C++ Build Tools.exe 安装包损坏](https://blog.csdn.net/zw521cx/article/details/117368970)
